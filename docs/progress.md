...
4. **Ревю §9** — зведено у чек-лист [`docs/section9-decisions.md`](section9-decisions.md): 173 пункти → 8 груп, 5 реальних розвилок (2 з них — зміна схеми: `OWNER_TYPE` + backfill рахунків; типізовані `VALUE_*` доп.реквізитів). Чекає рішень власника → далі батч 007 (ALTER'и).
