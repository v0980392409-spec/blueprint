...
- app 100 MASTER (еталон), app 122 ERP (порожній цільовий), app 130 ВД, **app 200 BUDYNKY** (пілот; **12 сторінок**; браузери живих даних: Організації, Контрагенти, Користувачі + **стор. 11 «Погодження»** — процеси Согласование 500 з лейблами Стан/Варіант/Результат і лічильниками ТЧ).
